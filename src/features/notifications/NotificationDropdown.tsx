  ...
  return (
    <Popover>
      ...
      <PopoverContent
        align="end"
        sideOffset={12}
        className="w-[calc(100vw-2rem)] sm:w-[420px] p-0 rounded-[32px] border-none bg-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] ring-1 ring-slate-200/60 overflow-hidden animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-300 z-[100]"
      >
        {/* --- BRANDED HEADER --- */}
